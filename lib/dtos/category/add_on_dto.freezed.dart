...
AddOnDto _$AddOnDtoFromJson(Map<String, dynamic> json) {
  return _AddOnDto.fromJson(json);
}
...
/// @nodoc
@JsonSerializable()
class _$_AddOnDto implements _AddOnDto {
  const _$_AddOnDto(
      {this.id,
      required this.title,
      required this.price,
  ...
  @override
  String toString() {
    return 'AddOnDto(id: $id, title: $title, price: $price, imageUrl: $imageUrl, isSelected: $isSelected, quantitySelected: $quantitySelected, createdAt: $createdAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_AddOnDtoToJson(
      this,
    );
  }
}

abstract class _AddOnDto implements AddOnDto {
  const factory _AddOnDto(
      {final String? id,
