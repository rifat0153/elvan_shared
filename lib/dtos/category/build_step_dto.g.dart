...
_$_FoodItemBuildStepDtos _$$_FoodItemBuildStepDtosFromJson(
        Map<String, dynamic> json) =>
    _$_FoodItemBuildStepDtos(
...
Map<String, dynamic> _$$_FoodItemBuildStepDtosToJson(
        _$_FoodItemBuildStepDtos instance) =>
    <String, dynamic>{
      'id': instance.id,
